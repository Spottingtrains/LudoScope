...
<main class="large-padding">
    <section id="jeuEdit" class="up-down-padding">
        ...
        <a href="index.php?url=profile" class="btn btn-secondary-empty">Retour au profil</a>
        ...
        <form id="jeu-edit-form" method="POST" action="index.php?url=jeu/edit&id=<?= (int)$jeu['id_jeu'] ?>" class="row g-3" enctype="multipart/form-data">
            ...
            <!-- Image de couverture actuelle + upload -->
            <div class="col-12">
        ...
        <!-- ===== Fin formulaire de demande de modification ===== -->
        <?php endif; ?>
    </section>
</main>
